  ...
  return (
    <Box sx={{ backgroundColor: "#444658", py: "1rem", minHeight: "100vh" }}>
      <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
        ...
        >
          <Box sx={{ textAlign: 'center', fontSize: '39px', fontWeight: 'bold' }}>
            {action}
          </Box>
              ...
              {action === "Login" && (
                <>
                  <Box sx={inputStyle}>
                    ...
                    <input placeholder="Email" type="email" style={inputFieldStyle}
                      value={email}
                  ...
                  <Box sx={inputStyle}>
                    ...
                    <input placeholder="Password" type="password" style={inputFieldStyle}
                      value={password}
              ...
              {action === "SignUp" && (
                <>
                  <Box sx={inputStyle}>
                    ...
                    <input placeholder="Name" type="text" style={inputFieldStyle}
                      value={name}
